# Legal Disclaimers & Third-Party Attributions

This document outlines the intellectual property disclaimers and third-party license attributions associated with the **Industrialist Calculator** project.

---

## 1. Game Assets & Data Disclaimer

All game names, recipe configurations, machine formulas, and product values associated with the game **Industrialist** are the sole intellectual property of the game's developers (**Mamytema Studios**). These assets and data are utilized in this project for non-commercial, community-driven informational purposes with no intent to infringe.

This calculator is an unofficial, fan-made utility. It is not endorsed by, affiliated with, sponsored by, or associated with Mamytema Studios.
...
## 4. Rights Holder Inquiries & Takedowns

If you are a copyright holder and have concerns regarding the inclusion of any particular data or assets in this project, please open a GitHub issue, and the maintainers will respond and comply with removal requests promptly.
