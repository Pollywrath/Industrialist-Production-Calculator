...
export const large_liquid_truck_depot_01: SpecialRecipe = createSpecialRecipe({
  id: 'r_large_liquid_truck_depot_01',
  name: 'Sell Fluid',
  machineId: 'm_large_liquid_truck_depot',
  isSellTrash: true,
  powerConsumption: 0,
  ...
  inputs: (_settings, _globalSettings, _nodeId, helpers) => {
    ...
    return [{ product_id: resolvedFluid, quantity: 4000, variable: true }];
  },
  outputs: [],
});
