...
const BoilerSettings = ({ nodeId, currentSettings, onSettingsChange, onClose }) => {
  const [heatLoss, setHeatLoss] = useState(
    currentSettings?.heatLoss !== undefined ? currentSettings.heatLoss : 8
  );

  const handleApply = () => {
    const settings = { heatLoss };
        ...
        <div className="drill-settings-content">
          <div className="drill-setting-group">
            ...
            <p style={{ 
              ...
              Temperature loss when converting hot water to steam. Default is 8°C.
            </p>
          </div>
          ...
          >
            ...
            <div style={{ color: '#999', lineHeight: '1.6' }}>
              ...
              <div>• Steam output temp = Input temp - {heatLoss}°C</div>
